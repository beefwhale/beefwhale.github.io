...
math: false
mermaid: false
img_path: /assets/img/posts/cadgptv1
image:
  path: cadgpt_cover.png
carousels:
  - images:
      - image: gallery1.jpg
      - image: gallery2.jpg
...
![Desktop View](macropad.png){: width="972" height="589" }
...
> [Joe Scotto](https://scottokeebs.com/) is **THE** GOAT when it comes to handwired keyboards and macropads, if you're interested in creating one on your own.
{: .prompt-tip }
...
![Desktop View](rhinogpt.png){: width="972" height="589" }
...
![Desktop View](cadgpt_research.png){: width="972" height="589" }
...
![Desktop View](cadgpt_architecture.png){: width="972" height="589" }
...
![Desktop View](rag.png){: width="972" height="589" }
...
![Desktop View](agentic.png){: width="972" height="589" }
...
![Desktop View](cadgpt_poster.png){: width="972" height="589" }
